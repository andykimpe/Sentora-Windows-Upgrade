...
ws_generic::DoPostRequest('http://api.sentora.org/hello.json', "version=" . sys_versions::ShowSentoraVersion() . "&platform=" . sys_versions::ShowOSPlatformVersion() . "&url=" . ctrl_options::GetSystemOption('sentora_domain') . "&zemail=" . $zadmin['email']);
