...
echo "#########################################################################" > %1\logs\Installers\sentora-windows-install.log
echo "Uninstall Zpanel" >> %1\logs\Installers\sentora-windows-install.log
echo "#########################################################################" > %1\logs\Installers\sentora-windows-install.log
...
C:\Windows\System32\reg.exe query HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\hMailServer
   if %ERRORLEVEL% EQU 0 (
C:\Windows\System32\reg.exe delete HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\hMailServer
   )
...
C:\Windows\System32\reg.exe query HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\hMailServer_is1
   if %ERRORLEVEL% EQU 0 (
C:\Windows\System32\reg.exe delete HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\hMailServer_is1
   )
