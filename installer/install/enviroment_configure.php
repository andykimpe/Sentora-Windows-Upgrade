...
exec("setso --set sentora_root " . $install_phpdir . "/panel/");
exec("setso --set temp_dir " . $install_phpdir . "/temp/");
exec("setso --set logfile " . $install_phpdir . "/logs/sentora.log");
exec("setso --set named_dir " . $install_phpdir . "/configs/bind/etc/");
exec("setso --set zone_dir " . $install_phpdir . "/configs/bind/zones/");
exec("setso --set bind_log " . $install_phpdir . "/logs/bind/bind.log");
exec("setso --set hosted_dir " . $install_phpdir . "/hostdata/");
exec("setso --set apache_vhost " . $install_phpdir . "/configs/apache/httpd-vhosts.conf");
exec("setso --set static_dir " . $install_phpdir . "/panel/etc/static/'");
exec("setso --set parking_path " . $install_phpdir . "/panel/etc/static/parking/");
exec("setso --set upload_temp_dir " . $install_phpdir . "/temp/");
exec("setso --set openbase_temp " . $install_phpdir . "/temp/");
exec("setso --set log_dir " . $install_phpdir . "/logs/");
exec("setso --set apache_budir " . $install_phpdir . "/backups/");
exec("setso --set zsudo " . $install_phpdir . "/panel/bin/zsudo");
exec("setso --set daemon_exer " . $install_phpdir . "/panel/bin/daemon.php");
