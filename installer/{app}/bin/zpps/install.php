...
$rndcconfgen="c:/zpanel/bin/bind/bin/rndc-confgen.exe";
$rcnd="c:/zpanel/bin/bind/etc/rndc.conf";
$logdir='c:/zpanel/logs/bind/';
$nameddir="c:\\zpanel\\bin\\bind\\etc\\";
$zonedir="C:/zpanel/bin/bind/zones/";
$zonedir="C:/zpanel/bin/bind/zones/";
$configdir="C:/zpanel/configs/bind/";
$configetcdir="C:/zpanel/configs/bind/etc/";
$configzonedir="C:/zpanel/configs/bind/zones/";
##########################################################################################################
...
include "c:\\zpanel\\configs\\bind\\etc\\named.conf";';
...
system('CACLS c:/zpanel/bin/bind/*.* /T /E /C /G "Users":C');
?>
